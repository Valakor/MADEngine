...
namespace MAD
{
	...
	public:
		...
		bool CompileShaderFromFile(const eastl::string& inFileName, const eastl::string& inShaderEntryPoint, const eastl::string& inShaderModel, eastl::vector<char>& inOutCompileByteCode, SInputLayoutId* outOptInputLayout = nullptr, const D3D_SHADER_MACRO* inShaderMacroDefines = nullptr);
