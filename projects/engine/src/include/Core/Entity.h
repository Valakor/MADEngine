...
namespace MAD
{
	...
	public:
		...
		inline void RegisterOwningWorldLayer(UGameWorldLayer& inWorldLayer) { m_owningWorldLayer = &inWorldLayer; }
		...
		inline UGameWorld& GetWorld() const { return m_owningWorldLayer->GetOwningWorld(); }
