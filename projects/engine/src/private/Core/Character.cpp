...
namespace MAD
{
	...
	void ACharacter::OnBeginPlay()
	{
		...
		meshComps[0].lock()->TEMPInitializeMeshInstance("engine\\meshes\\primitives\\sphere.obj", Matrix::CreateScale(10.0f) * Matrix::CreateTranslation(Vector3(1100.0f, 50.0f, 50.0f)));
		...
		GetFirstComponentByType<CPointLightComponent>().lock()->TEMPInitializePointLight(Vector3(1100.0f, 50.0f, 50.0f), Color(1.0f, 1.0f, 1.0f, 1.0f), 1.0f, 10.0f, 500.0f);
	}
}
